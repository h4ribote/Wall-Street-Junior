...
(1, 'Northern Alliance', 'Developed nations with high tech and stable politics.'),
(2, 'Eastern Coalition', 'Rapidly growing industrial powerhouses.'),
(3, 'Southern Resource Pact', 'Resource-rich nations with political instability.'),
(4, 'Oceanic Tech Arch', 'Tax havens and tech-focused city-states.');
...
(1, 1, 'VND', 'Venice Dollar'),
(2, 2, 'BRB', 'Boros Ruble'),
(3, 3, 'DRL', 'Dorado Real'),
(4, 4, 'ARC', 'Arcadian Credit'),
(5, 5, 'VDP', 'Verde Peso'),
...
(2, 'ENERGY', 'Energy'),
(3, 'FIN', 'Finance'),
(4, 'BIO', 'Healthcare / Bio'),
(5, 'CONS', 'Consumer / Retail'),
(6, 'DEF', 'Defense / Industrial'),
(7, 'LOG', 'Logistics / Transport');

-- Companies
INSERT INTO companies (company_id, country_id, sector_id, name, ticker_symbol, description) VALUES
(1, 4, 1, 'OmniCorp', 'OMNI', 'World largest AI company.'),
(2, 1, 1, 'CyberLife', 'CYB', 'Cybernetics and prosthetics.'),
(3, 2, 2, 'Titan Energy', 'TTN', 'Fossil fuel giant turning green.'),
(4, 3, 2, 'Helios Solar', 'SOL', 'Solar energy from deserts.'),
(5, 4, 3, 'Goliath Bank', 'GLT', 'Too big to fail investment bank.'),
(6, 1, 3, 'Shadow Fund', 'SHD', 'Algorithmic hedge fund.'),
(7, 4, 4, 'Chimera Genetics', 'CHM', 'Gene editing pioneer.'),
(8, 3, 4, 'Panacea Corp', 'PAN', 'Rare plant-based pharmaceuticals.'),
(9, 1, 5, 'Stardust Luxury', 'SDL', 'High-end fashion for cyborgs.'),
(10, 5, 5, 'Red Ox Food', 'ROX', 'Synthetic meat and grains.'),
(11, 2, 6, 'Iron Fist Armaments', 'IFA', 'Cheap and durable weaponry.'),
(12, 4, 6, 'Aegis Systems', 'AEG', 'Drone defense systems.'),
(13, 1, 7, 'Trans-Oceanic', 'TRN', 'Autonomous shipping fleet.'),
(14, 4, 7, 'Void Cargo', 'VDC', 'Space transport venture.'),
(15, 6, 2, 'Atomos Energy', 'ATM', 'Nuclear and geothermal energy.'),
(16, 7, 1, 'Silicon Dragon', 'SLD', 'Semiconductor manufacturing.'),
(17, 1, 5, 'Global News Network', 'GNN', 'Global media conglomerate.'),
(18, 4, 7, 'Horizon Logistics', 'HRZ', 'Drone delivery network.');

-- Resources
INSERT INTO resources (resource_id, name, type, description) VALUES
(1, 'Rare Earth Metals', 'METAL', 'Essential for electronics and batteries.'),
(2, 'Crude Oil', 'ENERGY', 'Fossil fuel for energy and plastics.'),
(3, 'Natural Gas', 'ENERGY', 'Clean fossil fuel for heating and power.'),
(4, 'Semiconductors', 'TECH', 'The rice of industry.'),
(5, 'Synthetic Meat', 'FOOD', 'Lab-grown meat.'),
(6, 'Grain', 'FOOD', 'Staple food crops.'),
(7, 'Uranium', 'ENERGY', 'Fuel for nuclear power plants.'),
(8, 'Water', 'BASIC', 'Industrial and drinking water.'),
(9, 'Steel', 'METAL', 'Basic material for construction and industry.'),
(10, 'Energy Credits', 'ENERGY', 'Tradable certificates for renewable energy.'),
(11, 'Bio-Gel', 'TECH', 'Advanced medical and cybernetic material.');
